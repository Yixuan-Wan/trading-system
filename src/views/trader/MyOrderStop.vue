...
<script>
  export default {
    ...
    methods: {
      ...
      getStopOrderList(){
        this.$axios.get("http://localhost:8080/order/list/stop?traderId="+this.traderId+"&pageNo="+this.currentPage+"&pageSize=5")
        .then(response => {
      ...
      CreateCancelOrder(orderId,quantity){
        ...
        this.$axios.post("http://localhost:8080/order/cancel/stop",cancelOrder)
        .then(response =>{
